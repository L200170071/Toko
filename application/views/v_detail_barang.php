         ...
         <div class="row">
             <div class="col-12 col-sm-6">
                 ...
                 <div class="col-12 product-image-thumbs">
                     ...
                     <?php foreach ($gambar as $key => $v) { ?>
                         <div class="product-image-thumb"><img src="<?= base_url('assets/foto/' . $v->gambar) ?>" alt="Product Image"></div>
                     <?php } ?>
                 </div>
             </div>
             <div class="col-12 col-sm-6">
                 <h3 class="mt-3"><?= $barang->nama_barang ?></h3>
