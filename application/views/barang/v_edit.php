<div class="col-md-12">
    ...
    <div class="card">
        <div class="card-header" style="background-color: darkorchid;">
            <h3 class="card-title text-white">Edit Data Barang</h3>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
            <?php
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        <label>Harga</label>
                        <input name="harga" class="form-control" placeholder="Rp." value="<?= $barang->harga ?>">
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="form-group">
            ...
            <div class="form-group">
                ...
                <textarea name="deskripsi" class="form-control" rows="7" cols="30" placeholder="Deskripsi"><?= $barang->deskripsi ?></textarea>
            </div>
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        <img id="gambar_load" src="<?= base_url('assets/gambar/' . $barang->gambar) ?>" width="400px">
                    </div>
                </div>
            </div>
